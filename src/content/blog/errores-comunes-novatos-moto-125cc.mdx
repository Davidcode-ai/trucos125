...
## Tabla: error → consecuencia → hábito correcto

| Error del novato | Consecuencia típica | Hábito que lo corrige |
|------------------|---------------------|------------------------|
| Manillar en rigor mortis | Vibración dirección | Rodillas al depósito, brazos flexionados |
| Solo freno trasero | Distancia de frenado larga | Delantero primero, suave, luego ambos |
| Mirar al peligro | Impacto con el obstáculo | Mirada a la salida de la curva |
| Centro del carril | Resbalón en mancha de aceite | Huella izquierda o derecha |
| Intermitente olvidado | Cruce frontal en stop | Cancelar cada 30 s en recta |
| Frenar en curva | Salida de trayectoria | Frenar antes de inclinar |
| Ir en camiseta | Abrasiones graves | Equipo mínimo siempre |

## Primeros 30 días con carnet B convalidado: plan de entrenamiento

**Semana 1:** Parking vacío o industrial de noche. Arranques, paradas, embrague (si es de marchas), intermitentes y espejos.

**Semana 2:** Ciudad a horas valle. Carril izquierdo del carril, distancia de seguridad, sin autovía.

**Semana 3:** Carretera secundaria con curvas suaves. Practica mirada lejana y frenada anticipada.

**Semana 4:** Autovía corta (20 min) si tu 125cc lo permite legalmente. Revisa presión de neumáticos y combustible antes.

No compitas con coches ni filtres entre filas hasta dominar el equilibrio a baja velocidad.
...
Antes de tu primera ITV, repasa [qué miran exactamente](/blog/como-pasar-itv-moto-125cc-primera/) y los [requisitos del permiso B](/blog/requisitos-convalidacion-carnet-b-moto-125cc-espana/) para circular legal.