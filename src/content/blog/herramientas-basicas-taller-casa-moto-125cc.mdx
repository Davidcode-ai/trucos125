...
## Tabla: inversión orientativa vs ahorro en taller (125cc)

| Herramienta | Precio aprox. | Te ahorra en… | Frecuencia de uso |
|-------------|---------------|---------------|-------------------|
| Maletín carraca Cromo-Vanadio | 50–80 € | Cualquier tornillo | Semanal |
| Llave dinamométrica | 35–50 € | Aceite, ejes, tapas | Mensual |
| Caballete trasero | 30–40 € | Cadena, rueda | Quincenal |
| Allen en T | 15–25 € | Carenados, asiento | Mensual |
| Kit mechas | 12–18 € | Pinchazo en ruta | 1–2 veces/año |
| Compresor portátil | 35–60 € | Presiones correctas | Semanal |
| Sprays (cadena, frenos) | 25 € total | Limpieza profesional | Mensual |

## Operaciones que ya puedes hacer con este kit

1. **Cambio de aceite** (filtro según manual): vaciado en frío, tornillo al par, nivel a mitad de ventana.
2. **Tensado y engrase de cadena** con la [guía dedicada](/blog/como-limpiar-engrasar-cadena-moto-125cc/).
3. **Comprobación de pastillas** y limpieza de disco con brake cleaner.
4. **Inflado preciso** antes de ruta o ITV.
5. **Reparación provisional de pinchazo** hasta taller.

## Errores de taller casero que las herramientas no evitan

- Apretar **sin torque** en tapones de aluminio.
- Usar **WD-40 en cadena** (mata retenes y mancha neumático).
- **Girar rueda con motor** al limpiar cadena.
- Guardar herramientas **oxidadas** en un garaje húmedo: invierte en una caja con silicona desecante.

<Adsense />

Cuando tengas el kit montado, enlázalo con el [mantenimiento básico periódico](/blog/mantenimiento-basico-moto-125cc-casa/) y prepara la moto nueva con un [rodaje](/blog/como-hacer-rodaje-moto-125cc-nueva/) responsable si acabas de sacarla del concesionario.