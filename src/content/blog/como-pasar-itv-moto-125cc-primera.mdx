...
## Tabla resumen: causas de suspensión más frecuentes en 125cc

| Motivo | Tipo de moto | Gravedad | Solución rápida en garaje |
|--------|--------------|----------|---------------------------|
| Falta catadióptrico trasero | Naked / deportiva con portamatrículas corto | Grave | Pegatina reflectante homologada bajo la placa |
| Escape sin homologación CE | Todas | Grave | Escape original o documentación + DB-Killer |
| CO elevado en gases | Todas | Grave | Ruta 20 min a revoluciones antes de la cita |
| Neumático fuera de ficha | Todas | Grave | Medidas e índice de carga/velocidad según tarjeta |
| Intermitentes LED rápidos | Todas | Grave | Resistencias o relé compatible |
| Pastillas al metal | Todas | Grave | Cambio de pastillas antes de la cita |
| Líquido de frenos oscuro | Todas | Leve–media | Purga y DOT4 nuevo (mejor en taller si no tienes experiencia) |

## Documentación que conviene llevar el día de la cita

Aunque no siempre la piden, ir preparado evita volver otro día:

1. **Permiso de circulación** y **ficha técnica** (ITV) actualizados.
2. **Seguro en vigor** (la estación suele contrastarlo en sistema).
3. Si cambiaste escape, **certificado de homologación** del fabricante.
4. Factura o justificante si montaste accesorios que alteran luces o matrícula.

## Coste orientativo y tiempos (España, 2026)

Las tasas varían por comunidad autónoma y estación privada. Como referencia para una moto de 125cc en inspección periódica bienvenida: entre **25 € y 40 €** de tasa más el margen del centro si contratas servicios extra (no obligatorios). El proceso en sí dura **10–20 minutos** si no hay cola y la moto está en regla.

## Después de aprobar: qué hacer con la pegatina

Pégala en un sitio visible (horquilla delantera o parte del chasis que marque el manual de tu ITV). Anota en el móvil la **fecha de caducidad** y programa un recordatorio **dos meses antes** del vencimiento biennal. Si vendes la moto, el comprador mirará esa pegatina antes que el kilometraje.

<Adsense />

¿Quieres ir a la ITV con la moto mecánicamente impecable? Revisa también nuestra [guía de mantenimiento básico en casa](/blog/mantenimiento-basico-moto-125cc-casa/) y el artículo sobre [cómo limpiar y tensar la cadena](/blog/como-limpiar-engrasar-cadena-moto-125cc/) si tu 125cc es de marchas.