...
## Tabla comparativa: rodaje en moto de marchas vs scooter 125cc

| Aspecto | Moto de marchas | Scooter automático |
|---------|-----------------|-------------------|
| Límite de vueltas | ~60–70 % zona roja (manual) | Evitar acelerón desde parado |
| Transmisión a cuidar | Cadena + tensores | Correa variador (sin engrase) |
| Ruta ideal | Secundarias con cambios | Urbano fluido, sin autovía fija |
| Frenos | Pastillas + disco delantero | También pastillas; mucho peso delantero al frenar |
| Neumáticos | Cera de fábrica ~100 km | Igual: no inclinaciones bruscas al inicio |
| Primera revisión | ~1.000 km aceite + cadena | ~1.000 km aceite; revisar variador en manual |

## Errores que anulan el rodaje (aunque “vaya suave”)

- **Aceite de coche** o viscosidad incorrecta: el motor sufre desde el kilómetro uno.
- **Arranque en frío y salir a tope** en el primer semáforo: desgaste en segmentos y biela.
- **Cadena seca** en motos de marchas nuevas: el kit se estira mal y da tirones que confundes con fallo de motor.
- **Omitir la revisión de 1.000 km** para “ahorrar”: el aceite sale gris de virutas; dejarlo es lijar el cilindro por dentro.

## Checklist semanal durante el primer mes

1. Comprobar **presión de neumáticos** en frío.
2. Mirar **nivel de aceite** en terreno plano.
3. En marchas: **holgura de cadena** y lubricación si llueve.
4. Frenar con **anticipación**; no cristalizar pastillas nuevas.
5. Anotar kilómetros hasta la cita de revisión oficial.

<Adsense />

Cuando termines el rodaje, entra en la rutina de [mantenimiento básico periódico](/blog/mantenimiento-basico-moto-125cc-casa/) y, si aún no la tienes, prepara la [ITV](/blog/como-pasar-itv-moto-125cc-primera/) con tiempo cuando toque el primer periodo legal.